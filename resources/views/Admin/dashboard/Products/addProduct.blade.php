...
">
    <h1> Add a product : </h1>
    <form style="line-height: 35px;" action="{{url('/admin/products/add/add')}}" method="POST" enctype="multipart/form-data">
        @csrf
       ...
       <br>
        ...
        <input class="form-control col" type="number" name="discount" id="#discount" />
        <label class="col-form-label p-2"> Selling Price : <span class="text-danger">*</span></label>
        <input class="form-control col" type="number" name="price" id="#price" />
       </div>
       <br>
        <div class="sliders row p-2" style="width: 100%;margin:auto;padding:15px">
            ...
            <select name="brand" class="form-select col form-control" id="brand">
                <option select> Select Brand </option>
